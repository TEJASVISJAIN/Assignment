              ...
              {formData.map((data, index) => (
                <React.Fragment key={`data-${index}`}>
                  <tr>
                    ...
                    <td>{data.items[0].itemId}</td>
                    <td>{data.items[0].itemName}</td>
                    <td>{data.items[0].itemDescription}</td>
                    <td>{data.items[0].itemPrice}</td>
                    <td>{data.items[0].itemQuantity}</td>
                  </tr>
                  {data.items.slice(1).map((item, itemIndex) => (
...
//             value={formData.dateOfIssue}
//             name="dateOfIssue"
//             onChange={(e) => editField(e.target.name, e.target.value,formData.infod)}
//             style={{ maxWidth: "150px" }}
//             required
//           />
//         </div>
